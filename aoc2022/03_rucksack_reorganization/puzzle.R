...
# target="_blank">rucksacks</a> with supplies for the jungle^[Where
# there's jungle, there's hijinxs.] journey. Unfortunately, that Elf
# didn't quite follow the packing instructions, and so a few items now
...
input <- "aoc2022/03_rucksack_reorganization/input.txt"

# Once you're done with part 1, run the following line to fetch part 2:
aor::day_continue("2022-12-03", "aoc2022/03_rucksack_reorganization/puzzle.R")
